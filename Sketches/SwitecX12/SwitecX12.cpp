...
const int stepPulseMicrosec = 100;
const int resetStepMicrosec = 450;
#define DEFAULT_ACCEL_TABLE_SIZE (sizeof(defaultAccelTable)/sizeof(*defaultAccelTable))

SwitecX12::SwitecX12(unsigned long steps, unsigned char pinStep, unsigned char pinDir)
{
  this->steps = steps;
...
void SwitecX12::stepTo(long position)
{
  int count;
  int dir;
...
void SwitecX12::advance()
{
  ...
  long delta = dir>0 ? targetStep-currentStep : currentStep-targetStep;
...
void SwitecX12::setPosition(unsigned long pos)
{
